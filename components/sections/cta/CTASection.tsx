              ...
              <div className="flex w-full flex-col gap-6">
                ...
                <div className="flex w-full flex-col gap-8">
                  <div className="flex flex-col gap-3 text-base font-medium text-muted-foreground">
                    <p>
                      {"Don't let pain hold you back. Our experienced physiotherapists are ready to assess your condition and create a personalised treatment plan that gets you moving again."}
                    </p>
                    <p>
                      Book your initial consultation today and take the first step towards a pain-free, active life.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <a
                      ...
                      className="flex min-h-12 items-center justify-center rounded-lg border border-border px-6 py-3 font-medium text-foreground transition-colors hover:bg-secondary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    >
                      {businessInfo.phone}
                    </a>
                  </div>
